...
const registry = new Map<string, Service>([
  ["api.stripe.com", { id: "api.stripe.com", provider: "emulator:stripe", seed: "seeds/stripe.yaml", lastSeenAt: "2026-08-30T09:14:00.000Z" }],
...
const openapi = await new OpenAPIGenerator({ schemaConverters: [new ZodToJsonSchemaConverter()] })
  .generate(contract, {
