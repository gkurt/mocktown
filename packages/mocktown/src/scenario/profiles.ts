...
export const BUILTIN_PROFILES: BuiltinProfile[] = [
  {
    name: 'anonymous',
    description:
      'No credentials at all. Every unauthenticated request maps here; use it to test what a signed-out visitor sees and which endpoints correctly refuse.',
    credentials: {},
    context: {},
    signIn: 'token-only',
  },
  {
    name: 'default',
    description:
      'The typical signed-in user: populated data, verified email, a normal-sized organisation. This is the persona recorded traffic informs, and the baseline other profiles are described against.',
  ...
  },
  {
    name: 'empty-org',
    description:
      'Brand-new signup: zero items, no teammates, unverified email. Differs from `default` by having no data at all — use it to test every empty state.',
